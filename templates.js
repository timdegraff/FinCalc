...
export const templates = {
    ...
    income: () => `
        <div class="bg-slate-800 rounded-[2.5rem] border border-slate-700/50 p-10 flex flex-col gap-8 relative group shadow-2xl shadow-black/40">
            ...
            <div class="space-y-4">
                ...
                <input data-id="name" type="text" placeholder="Employer Name" class="bg-transparent border-none outline-none w-full text-white font-black text-4xl placeholder:text-slate-700">
            ...
            <div class="grid grid-cols-2 gap-10">
                <div class="space-y-3">
                    <div class="flex justify-between items-center h-4">
                        <label class="text-[10px] uppercase font-black text-slate-500 tracking-widest">Amount</label>
                        <button data-action="toggle-freq" data-id="isMonthly" class="text-blue-500 hover:text-blue-400 font-black text-[10px]">Annual</button>
                    </div>
                    <input data-id="amount" data-type="currency" type="text" placeholder="$0" class="bg-transparent border-none outline-none w-full text-teal-400 font-black text-3xl h-10">
                    <div class="h-[1px] bg-slate-700/50 w-full"></div>
                </div>
                <div class="space-y-3">
                    ...
                    <input data-id="increase" type="number" step="0.1" placeholder="0" class="bg-transparent border-none outline-none w-full text-white font-bold text-3xl h-10">
                    <div class="h-[1px] bg-slate-700/50 w-full"></div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-10">
                <div class="space-y-3">
                    <div class="flex justify-between items-center h-4">
                        <label class="text-[10px] uppercase font-black text-slate-500 tracking-widest">Write-offs</label>
                        <button data-action="toggle-freq" data-id="writeOffsMonthly" class="text-pink-500 hover:text-pink-400 font-black text-[10px]">Annual</button>
                    </div>
                    <input data-id="writeOffs" data-type="currency" type="text" placeholder="$0" class="bg-transparent border-none outline-none w-full text-pink-500 font-black text-3xl h-10">
                    <div class="h-[1px] bg-slate-700/50 w-full"></div>
                </div>
                <div class="space-y-3">
                    <div class="flex items-center h-4">
                    ...
                    <input data-id="bonusPct" type="number" placeholder="0" class="bg-transparent border-none outline-none w-full text-white font-bold text-3xl h-10">
                    <div class="h-[1px] bg-slate-700/50 w-full"></div>
                </div>
            </div>
            ...
            <div class="p-8 bg-slate-900/40 rounded-[1.5rem] border border-slate-700/30">
                <div class="grid grid-cols-2 gap-10">
                    <div class="space-y-3">
                        ...
                        <input data-id="contribution" type="number" placeholder="0" class="bg-transparent border-none outline-none w-full text-white font-bold text-3xl h-10">
                        <div class="h-[1px] bg-slate-700/50 w-full"></div>
                    </div>
                    <div class="space-y-3">
                        <div class="flex items-center h-4">
                        ...
                        <input data-id="match" type="number" placeholder="0" class="bg-transparent border-none outline-none w-full text-white font-bold text-3xl h-10">
                        <div class="h-[1px] bg-slate-700/50 w-full"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-10 items-end">
                <div class="space-y-3">
                    ...
                    <input data-id="taxFreeUntil" type="number" placeholder="0" class="bg-transparent border-none outline-none w-full text-white font-bold text-3xl h-10">
                    <div class="h-[1px] bg-slate-700/50 w-full"></div>
                </div>
    ...
    `,
    "budget-savings": (data) => `
        <td class="px-6 py-2"><input data-id="name" data-paste="spreadsheet" type="text" placeholder="Account" class="input-base w-full" ${data.isLocked ? 'readonly' : ''}></td>
