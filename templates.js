...
export const templates = {
    ...
    `,
    income: () => `
        <td class="px-4 py-2"><input data-id="name" type="text" placeholder="Job" class="input-base w-full"></td>
        <td class="px-4 py-2"><input data-id="amount" data-type="currency" type="text" placeholder="$0" class="input-base w-full text-right text-teal-400"></td>
        <td class="px-4 py-2 text-center"><input data-id="remainsInRetirement" type="checkbox"></td>
        <td class="px-4 py-2 text-center"><button data-action="remove" class="text-slate-500 hover:text-red-400"><i class="fas fa-times"></i></button></td>
    `,
    "budget-savings": () => `
        <td class="px-4 py-2"><input data-id="name" type="text" placeholder="Savings" class="input-base w-full"></td>
    ...
    `,
    "budget-expense": () => `
        <td class="px-4 py-2"><input data-id="name" type="text" placeholder="Expense" class="input-base w-full"></td>
